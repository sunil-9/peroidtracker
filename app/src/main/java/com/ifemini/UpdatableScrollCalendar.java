 ...
 */
public class UpdatableScrollCalendar extends LinearLayoutCompat implements ResProvider {
    ...
    public UpdatableScrollCalendar(Context context, AttributeSet attrs) {
        super(context, attrs);
        initStyle(context, attrs);
        init(context);
    }

    public UpdatableScrollCalendar(Context context, AttributeSet attrs, int defStyleAttr) {
